...
function showPage(page) {
    ...
    items.forEach(function(item) {
        htmlContent += '<tr>';
	    htmlContent += '<td>';
	    htmlContent += '<a href="javascript:void(0)" onclick="moveMap(\'' + item.RDNWHLADDR + '\', \'' + item.BPLCNM + '\')">' + item.BPLCNM +'</a>';
	    htmlContent += '</td>';
	    htmlContent += '<td>' + item.RDNWHLADDR + '</td>';
	    htmlContent += '<td>' + item.SITETEL + '</td>';
	    htmlContent += '</tr>';
    });
